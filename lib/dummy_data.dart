...
import 'package:e_commerce/features/shopping/models/product_attribute_model.dart';
...
//   /// List of all Categories
  static final List<CategoryModel> categories = [
    /// Parent Categories
    CategoryModel(id: '1', name: 'Clothes', image: UImages.clothesIcons, isFeatured: true),
    CategoryModel(id: '2', name: 'Shoes', image: UImages.shoesIcons, isFeatured: true),
    CategoryModel(id: '3', name: 'Cosmetics', image: UImages.cosmeticsIcons, isFeatured: true),
    CategoryModel(id: '4', name: 'Electronics', image: UImages.electronicsIcons, isFeatured: true),
    CategoryModel(id: '5', name: 'Furniture', image: UImages.furnitureIcons, isFeatured: true),
    CategoryModel(id: '6', name: 'Sports', image: UImages.sportsIcons, isFeatured: true),

    /// Clothes
    CategoryModel(id: '7', name: 'Shirts', image: UImages.shirtIcons, parentId: '1'),
    CategoryModel(id: '8', name: 'Jackets', image: UImages.jacketsIcons, parentId: '1'),
    CategoryModel(id: '9', name: 'Shorts', image: UImages.shortsIcons, parentId: '1'),

    /// Shoes
    CategoryModel(id: '10', name: 'Formal Shoes', image: UImages.formalShoesIcons, parentId: '2'),
    CategoryModel(id: '11', name: 'Sports Shoes', image: UImages.sportsShoesIcons, parentId: '2'),

    /// Cosmetics
    CategoryModel(id: '12', name: 'Face', image: UImages.faceIcons, parentId: '3'),
    CategoryModel(id: '13', name: 'Hair Oils', image: UImages.hairIcons, parentId: '3'),
    CategoryModel(id: '14', name: 'Bags', image: UImages.bagsIcons, parentId: '3'),
    CategoryModel(id: '15', name: 'Perfumes', image: UImages.perfumeIcons, parentId: '3'),
    CategoryModel(id: '16', name: 'Watches', image: UImages.watchIcons, parentId: '3'),

    /// Electronics
    CategoryModel(id: '17', name: 'Gadgets', image: UImages.gadgetsIcons, parentId: '4', isFeatured: false),
    CategoryModel(id: '18', name: 'Laptops', image: UImages.laptopsIcons, parentId: '4', isFeatured: false),
    CategoryModel(id: '19', name: 'Mobiles', image: UImages.mobileIcons, parentId: '4', isFeatured: false),

    /// Furniture
    CategoryModel(id: '20', name: 'Bed', image: UImages.bedIcons, parentId: '5', isFeatured: false),
    CategoryModel(id: '21', name: 'Lamps', image: UImages.lampIcons, parentId: '5', isFeatured: false),

    /// Sports
    CategoryModel(id: '22', name: 'Cricket', image: UImages.cricketIcons, parentId: '6', isFeatured: false),
    CategoryModel(id: '23', name: 'Soccer', image: UImages.soccerIcons, parentId: '6', isFeatured: false),
  ];
...
//   /// List of all Brands
  static final List<BrandModel> brands = [
    BrandModel(
        id: '1',
        image: 'https://res.cloudinary.com/dvkmnkzey/image/upload/v1775634462/Brands/gyztipd9yslfolcjftie.png',
        name: 'Nike',
        productsCount: 2,
        isFeatured: true),
    BrandModel(
        id: '2',
        image: 'https://res.cloudinary.com/dvkmnkzey/image/upload/v1775634465/Brands/zovnabrpkgsdhclew0ns.jpg',
        name: 'Adidas',
        productsCount: 2,
        isFeatured: true),
    BrandModel(
        id: '3',
        image: 'https://res.cloudinary.com/dvkmnkzey/image/upload/v1775634466/Brands/qnbl4esju8eemcal2rqn.jpg',
        name: 'Apple',
        productsCount: 8,
        isFeatured: true),
    BrandModel(
        id: '4',
        image: 'https://res.cloudinary.com/dvkmnkzey/image/upload/v1775634467/Brands/ty1z5lbq4qxieo0cevgp.png',
        name: 'Bata',
        productsCount: 4,
        isFeatured: true),
    BrandModel(
        id: '5',
        image: 'https://res.cloudinary.com/dvkmnkzey/image/upload/v1775634469/Brands/v16zav98pcjnsdncyldz.png',
        name: 'Bloody',
        productsCount: 9,
        isFeatured: false),
    BrandModel(
        id: '6',
        image: 'https://res.cloudinary.com/dvkmnkzey/image/upload/v1775634471/Brands/sjbeemsfejqzvml0cu4g.jpg',
        name: 'Breakout',
        productsCount: 7,
        isFeatured: true),
    BrandModel(
        id: '7',
        image: 'https://res.cloudinary.com/dvkmnkzey/image/upload/v1775634472/Brands/dpbdf3xxesfxbn5gzpru.png',
        name: 'Dari Mooch',
        productsCount: 4,
        isFeatured: true),
    BrandModel(
        id: '8',
        image: 'https://res.cloudinary.com/dvkmnkzey/image/upload/v1775634473/Brands/kophbjqqnuwq1v306xay.jpg',
        name: 'Interwood',
        productsCount: 9,
        isFeatured: false),
    BrandModel(
        id: '9',
        image: 'https://res.cloudinary.com/dvkmnkzey/image/upload/v1775634475/Brands/v6vqmxw93g9cfd7emioa.jpg',
        name: 'HP',
        productsCount: 4,
        isFeatured: false),
    BrandModel(
        id: '10',
        image: 'https://res.cloudinary.com/dvkmnkzey/image/upload/v1775634476/Brands/tkp7vtjjawo9lozharsk.png',
        name: 'J.',
        productsCount: 8,
        isFeatured: true),
    BrandModel(
        id: '11',
        image: 'https://res.cloudinary.com/dvkmnkzey/image/upload/v1775634478/Brands/merowy8oboqpzlltm2vd.png',
        name: 'NDURE',
        productsCount: 4,
        isFeatured: true),
    BrandModel(
        id: '12',
        image: 'https://res.cloudinary.com/dvkmnkzey/image/upload/v1775634479/Brands/hq6ttauvlirkpztqf6ib.jpg',
        name: 'NorthStar',
        productsCount: 2,
        isFeatured: true),
    BrandModel(
        id: '13',
        image: 'https://res.cloudinary.com/dvkmnkzey/image/upload/v1775634481/Brands/epnrsiq7fqw2epxvcxjo.png',
        name: 'Polo',
        productsCount: 2,
        isFeatured: true),
  ];
