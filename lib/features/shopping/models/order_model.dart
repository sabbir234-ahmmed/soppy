...
class OrderModel{
  ...
  String get formattedOrderDate => UHelperFunction.getFormattedDate(orderDate);

  String get formattedDeliveryDate =>  deliveryDate!=null ? UHelperFunction.getFormattedDate(deliveryDate!): "";
